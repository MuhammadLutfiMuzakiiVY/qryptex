...
pub const ZETAS: [i16; 128] = [
    ...
    1223, 652, -552, 1015, -1293, 1491, -282, -1544, 516, -8, -320, -666, -500, 488, 1014, -130,
    303, -1422, -991, -24, 762, -1071, 1084, -580, -1456, 1284, -1304, -883, 907, -1367, -499,
    1534, 1247, -700, -1146, 1269, 1107, -1187, -1389, -1457, -739, -439, 230, -120, 378, -244,
    514, -812, -607, 758, -64, -1200, 1162, 432, -872, -498, -1304, -608, -1274, -968, -1397, 901,
    -177, 54, -1440, 1104, -995, 1286, 112, 852, 1020, -1364, 1210, 155, 1354, -1324, -480, -644,
    -1102, 1312, -1415, -988, -919, 774, -643, 33, -900, 1431, -264, 648, 701, -315, -9, 1336, 943,
    719,
];
    ...
    while len <= 128 {
        ...
        while start < 256 {
            ...
            for j in start..start + len {
                ...
                poly[j + len] =
                    montgomery_reduce((zeta as i32) * (t as i32 - poly[j + len] as i32));
            }
            start += 2 * len;
        }
        len <<= 1;
